...
public class ProjectsTest {
    ...
    public void getProject() throws FreshBooksException, IOException {
        ...
        assertEquals(Project.ProjectBilledStatus.UNBILLED, project.getBilledStatus());
        assertEquals(Project.ProjectBillingMethod.PROJECT_RATE, project.getBillingMethod());
